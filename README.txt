...
- 公开版优先打开国内平台搜索页，避免 archive.org 在手机和国内网络中加载失败。
- archive.org 视频地址只作为备用参考，需要联网且可能受地区/网络影响。
- 如果你有授权视频或自有视频源，可以在 app.js 中把 getVideoSource() 改成对应的直连 MP4、B 站嵌入页或自有对象存储地址。
